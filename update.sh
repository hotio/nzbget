...
if [[ ${1} == "checkdigests" ]]; then
    ...
    [[ -z ${version} ]] && exit 1
    sed -i "s/{NZBGET_VERSION=[^}]*}/{NZBGET_VERSION=${version}}/g" .github/workflows/build.yml
    sed -i "s/{NZBGET_VERSION_SHORT=[^}]*}/{NZBGET_VERSION_SHORT=${version//-testing/}}/g" .github/workflows/build.yml
